...
class _DetailJadwalState extends State<DetailJadwal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromRGBO(232, 244, 247, 1.0),
      body: SafeArea(
        child: Container(
          child: Column(
            ...
            children: <Widget>[
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            style: TextStyle(color: Color.fromRGBO(48, 180, 172, 1.0), fontFamily: 'Montserrat'),),
                          ),
                          SizedBox(width: 10,),
                          Container(
                            width: 150,
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  Color.fromRGBO(125, 198, 149, 1.0),
                                  Color.fromRGBO(48, 180, 172, 1.0),
                                ],
                              ),
                            ),
              ...
              FlatButton.icon(
                  onPressed: () {},
                  icon: Icon(Icons.location_on, color: Color.fromRGBO(48, 180, 172, 1.0),),
                  label: Text('Mencari Lokasi',
                  style: TextStyle(color: Color.fromRGBO(48, 180, 172, 1.0),
                  fontFamily: 'Montserrat',
                  fontSize: 14),
                  ),
              ),
